...
export default function LandingPage() {
  ...
  return (
    <>
      <InteractiveDots />
      <div className="layout-container" style={{ paddingBottom: "64px", position: "relative", zIndex: 1 }}>
        {/* Header */}
        <header className="header-nav" style={{ background: "transparent", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <main style={{ display: "flex", flexDirection: "column", gap: "64px", marginTop: "80px" }}>
          ...
          <section className="panel" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "24px", textAlign: "center", background: "rgba(9, 9, 11, 0.8)", backdropFilter: "blur(4px)" }}>
            <div>
          ...
          <section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px" }}>
              ...
              <div className="panel-interactive" style={{ display: "flex", flexDirection: "column", gap: "16px", background: "rgba(9, 9, 11, 0.8)", backdropFilter: "blur(4px)" }}>
                <Shield size={32} color="var(--accent-blue)" />
                <h3 style={{ fontSize: "18px", fontWeight: 600 }}>Privacy & Trustless</h3>
                <p style={{ color: "var(--text-secondary)", fontSize: "14px", lineHeight: 1.5 }}>
                  Utilizing Zero-Knowledge proofs (SP1) means the base data never leaves the prover. Trust the mathematics, not the hardware.
                </p>
              </div>

              <div className="panel-interactive" style={{ display: "flex", flexDirection: "column", gap: "16px", background: "rgba(9, 9, 11, 0.8)", backdropFilter: "blur(4px)" }}>
                <Terminal size={32} color="var(--accent-green)" />
                <h3 style={{ fontSize: "18px", fontWeight: 600 }}>Verifiable Execution</h3>
                <p style={{ color: "var(--text-secondary)", fontSize: "14px", lineHeight: 1.5 }}>
                  Soroban smart contracts on the Stellar network mathematically verify the generated SP1 proofs instantly and cost-effectively.
                </p>
              </div>

              <div className="panel-interactive" style={{ display: "flex", flexDirection: "column", gap: "16px", background: "rgba(9, 9, 11, 0.8)", backdropFilter: "blur(4px)" }}>
                <Server size={32} color="var(--text-primary)" />
                <h3 style={{ fontSize: "18px", fontWeight: 600 }}>Decentralized Provers</h3>
                <p style={{ color: "var(--text-secondary)", fontSize: "14px", lineHeight: 1.5 }}>
                  A competitive open marketplace where Prover Nodes race to execute jobs and claim the bounty. Scale your compute seamlessly.
                </p>
              </div>
